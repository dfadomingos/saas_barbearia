...
export const POST = async (request: Request) => {
  ...
  const result = streamText({
    ...
    4. Se o usuário pedir agendamento para uma data do mesmo dia, forneça APENAS os horários que ainda não passaram (ex: se no momento da mensagem for 15:00, não mostre horários anteriores a isso)
    ...
    6. Se o usuário pedir agendamento para uma data do mesmo dia, forneça APENAS os horários que ainda não passaram (ex: se no momento da mensagem for 15:00, não mostre horários anteriores a isso)

    CENÁRIO 3 - Usuário somente escolhe a barbearia e data inicialmente e não apresenta horário:
    1. apresentar TODOS os horários disponíveis para a barbearia e data escolhidas
    2. Se o usuário pedir agendamento para uma data do mesmo dia, forneça APENAS os horários que ainda não passaram (ex: se no momento da mensagem for 15:00, não mostre horários anteriores a isso)
    ...
    Importante:
    - SEMPRE listar de forma formatada e clara as informações para o usuário
    - no resumo final, aprensente a data no formato "DD/MM/YYYY".
